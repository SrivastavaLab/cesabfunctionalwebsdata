...
## recalculating the volume equations

This document retraces the process used by Regis (and Kurt?) for creating & choosing the relationships for filling in data of bromeliad size. 

```{r}
kable(head(mertensii))
