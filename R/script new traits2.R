...
#### Body form (cross section x dorsal shape) -  flat elongate, flat ovoid, circular elongate, circular ovoid) - (Fabíola will help)
#### Cohort production interval (time from hatching to emergence)  -  <3 weeks,  3 weeks – 2 months,  2 – 4 months,  >4 months) - (Regis)
...
trait<-read.csv("spp_trait_diane2.csv")
colnames(trait)
...
write.csv(trait.2, "forupload_paula.csv")
